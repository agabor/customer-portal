...
export class Presenter {
  ...
  updateText(text: Text) {
    const res = this.api.projectsIdTextsTextIdPost(this.activeProject.slug, text.textId, text.name, text.description,
      text.startGroup, text.minLength, text.maxLength);
    res.subscribe(newText => {
      console.log(newText);
    }, error => {
  ...
  deleteText(text: Text) {
    const res = this.api.projectsIdTextsTextIdDelete(this.activeProject.slug, text.textId);
    res.subscribe(newText => {
      console.log(newText);
    }, error => {
      console.log(error);
